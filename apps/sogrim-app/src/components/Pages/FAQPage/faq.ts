...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    content:
      "עליכם לאפס את המשתמש. לחיצה על האווטר בחלק העליון של המסך, ולאחר מכאן אפס משתמש.",
  },
  {
  ...
  },
  {
    ...
    content:
      "השדות מס׳ קורס וסטאטוס אינם ניתן לעריכה במכוון. אם תרצו מס׳ קורס אחר, עליכם להוסיף קורס חדש. באשר לסטאטוס, הוא מתעדכן בהתאם לציון.",
  },
  {
