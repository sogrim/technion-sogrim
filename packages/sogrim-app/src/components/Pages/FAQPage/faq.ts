...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    content:
      'מסד הנתונים שלנו די גדול, אך יתכנו שינויים וכמובן אישורים ספציפיים. למשל, סטודנט שעשה את הקורסים הישנים "מערכות ספרתיות" ו-"תכן לוגי" שהוחלפו ב-"מערכות ספרתיות ומבנה המחשב" החדש, יוכל לסמן זאת בצורה ידנית דרך הממשק שלנו.',
  },
  {
