...
/// Build a mapping from (year, term) to semester display string (e.g. "חורף_2020-2021").
/// Uses the actual academic year range from the grade sheet instead of sequential numbering.
