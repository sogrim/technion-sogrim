    ...
    let mut degree_status = DegreeStatus {
        course_statuses: vec![
            cs(
                ...
                false,
                Some(AcademicSemester::new(SemesterSeason::Winter, 2025)),
                Some("hova"),
            ),
            cs(
                "dup",
                ...
                true,
                Some(AcademicSemester::new(SemesterSeason::Spring, 2025)),
                Some("hova"),
            ),
        ],
        ..Default::default()
    ...
    let mut degree_status = DegreeStatus {
        course_statuses: vec![
            ...
            cs(
                ...
                Some(CourseState::Complete),
                true,
                Some(AcademicSemester::new(SemesterSeason::Summer, 2025)),
                Some("hova"),
            ),
        ],
        ..Default::default()
    ...
    let mut degree_status = DegreeStatus {
        course_statuses: vec![
            cs(
                ...
                Some(CourseState::Irrelevant),
                true,
                Some(AcademicSemester::new(SemesterSeason::Winter, 2026)),
                Some("hova"),
            ),
            cs(
                "dup",
