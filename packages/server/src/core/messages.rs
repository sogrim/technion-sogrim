...
pub fn english_requirement_for_exempt_students_msg() -> String {
    "לא השלמת את דרישת האנגלית לסיום התואר. סטודנטים שהתחילו את לימודיהם החל מתשפ\"ב נדרשים לקחת שני קורסי תוכן באנגלית.".to_string()
}

pub fn english_requirement_for_technical_advanced_b_students_msg() -> String {
    "לא השלמת את דרישת האנגלית לסיום התואר. סטודנטים שהתחילו את לימודיהם החל מתשפ\"ב נדרשים לקחת קורס תוכן באנגלית בנוסף לקורס אנגלית טכנית מתקדמים ב ".to_string()
}
