          ...
          <TooltipProvider delayDuration={200}>
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-xs text-right">
                <p>
                  {
                    "חלונית זו מאפשרת להקצות נקודות זיכוי לדרישות התואר השונות, בהתאם לכמות נקודות הזיכוי שברשותך - כולל נקודות מילואים, פעילות חברתית וזיכויים נוספים."
                  }
                </p>
                <p>
                  {
                    'כדי להוסיף נקודות זיכוי נוספות, יש להיכנס ללשונית "פטורים וזיכויים" ולהוסיף קורסים מסוג "פעילות חברתית".'
                  }
                </p>
              </TooltipContent>
            </Tooltip>
